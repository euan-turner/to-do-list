...
function prioritise() {
  ...
  if (id === "todo") {
    ...
    //take the item out of the to-do list, and add it to the prioritise list
    //change text colour to signify priority
    item.style.color = "red";
    data.todo.splice(data.todo.indexOf(value), 1);
    data.priority.push(value);
  } else {
    //take the item out of the prioritise list, and add it to the todo list
    //revert text colour
...
function completeItem() {
  ...
  if (id === "todo") {
    //if completing item in to-do list
    //take the item out of the to-do list and add it to completed list
    alert("Congratulations, you completed a task");
    data.todo.splice(data.todo.indexOf(value), 1);
    data.completed.push(value);
  } else if (id === "priority") {
    //if completing item in priority list
    alert("Congratulations, you completed a priority task");
    item.style.color = "black";
    data.priority.splice(data.priority.indexOf(value), 1);
    data.completed.push(value);
  } else {
